...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String qry="create table watchletter(id INTEGER PRIMARY KEY AUTOINCREMENT,imageId TEXT,title TEXT,category TEXT,views TEXT,likes TEXT)";
    ...
    public Cursor insertData(String imageId, String title, String category, Integer views, Integer likes) {
        ...
        String qry="insert into watchletter(imageId,title,category,views,likes) values ('"+imageId+"','"+title+"','"+category+"','"+views+"','"+likes+"')";
        db.execSQL(qry);
            return null;
    }
    ...
    public Cursor readdata(){
        ...
        String qry="select * from watchletter";
    ...
    public void deleteData(String id) {
        ...
        String qry="delete from watchletter where imageId='"+id+"'";
        db.execSQL(qry);
    }
